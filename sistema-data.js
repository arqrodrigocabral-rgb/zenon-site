...
(function (root) {
  ...
  const PROJETOS = {
    ...
    'P-04': {
      ...
      fase: 'Protocolo protocolado · aguardando órgão',
      tags: ['Aguardando aprovação', '🎁 Gratuito', 'Órgão Público'],
      progresso: 67,
      etapas: '4 / 6',
      prazoInicio: '—',
      prazoFinal: '—',
      rrt: null,
      obs: '🎁 Serviço gratuito. 4 de 6 etapas concluídas — processo protocolado, aguardando aprovação do órgão competente.',
      restanteDias: null,
      obraId: null,
      financeiroId: null,
      propostaId: null,
      ...
      orcamentoObra: 0,
      gastoObra: 0,
      drive: '1MjmmSQLtHIuQMGf7aUHZHb59SBA8CWNw',
      driveLinks: [
        { label: '📁 Pasta do Projeto', url: 'https://drive.google.com/drive/folders/1MjmmSQLtHIuQMGf7aUHZHb59SBA8CWNw' }
      ],
      fases: [
        { st:'done', t:'Setup / Arquivos',           d:'Pasta do projeto criada, estrutura organizada.', q:'Concluído' },
        { st:'done', t:'Levantamento / Planta',       d:'Levantamento técnico e planta existente elaborados.', q:'Concluído' },
        { st:'done', t:'Documentação',                d:'Documentação necessária coletada e revisada.', q:'Concluído' },
        { st:'done', t:'Protocolo no órgão',          d:'Dossiê protocolado no órgão competente.', q:'Concluído' },
        { st:'now',  t:'Aguardando aprovação',        d:'Processo em análise pelo órgão. Aguardando retorno.', q:'Em andamento' },
        { st:'',     t:'Regularização · Entrega',     d:'Emissão do documento de regularização e entrega ao cliente.', q:'—' }
      ],
      decisoes: [
